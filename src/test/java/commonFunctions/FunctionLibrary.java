...
public class FunctionLibrary {
	...
	public static void supplierTable()throws Throwable
	{
		...
		String Act_Data =  wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//table[@class='table ewTable']/tbody/tr[1]/td[6]/div/span/span"))).getText();
	...
	public static void customerTable()throws Throwable
	{
		...
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		String Act_Data =  wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//table[@class='table ewTable']/tbody/tr[1]/td[5]/div/span/span"))).getText();
		Reporter.log(Exp_Data+"      "+Act_Data,true);
		try {
